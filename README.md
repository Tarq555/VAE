...
"# StyleGAN2-VAE"  git init git add README.md git commit -m "first commit" git branch -M main git remote add origin git@github.com:Tarq555/StyleGAN2-VAE.git git push -u origin main
